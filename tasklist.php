...
<html>
	...
	<body>
			...
			<div>
				<form name="newTask" action="tasklist.php" method="post">
					<label>
	...
	<?php
        ...
        class TaskList
        {
            ...
            {
            	$myfile = fopen("tasks.csv", "w") or die("Unable to open file!");
				$txt = $aTask->getTask(). "," .$aTask->getDescription(). "," .$aTask->getCreated(). "," .$aTask->getCompleted();
				fwrite($myfile, $txt);
				fclose($myfile);
            }
